...
export const Pagination: FC<{ productData: any, page: number, setPage: (page: number) => void }> = function ({ productData, page, setPage ,totalData}) {
    ...
    <div className="sticky right-0 bottom-0 w-full items-center border-t border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 sm:flex sm:justify-between">
      <div className="mb-4 flex items-center sm:mb-0">
        <a
          href="#"
          className="inline-flex cursor-pointer justify-center rounded p-1 text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
          onClick={handlePreviousPage}  // Correct placement of onClick for "Previous"
        >
        ...
        <a
          ...
          onClick={handleNextPage}  // Correct placement of onClick for "Next"
        >
        ...
        <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
          ...
          <span className="font-semibold text-gray-900 dark:text-white">
            {page * 20 - 19}-{Math.min(page * 20, 2290)}
          </span>
          &nbsp;of&nbsp;
          <span className="font-semibold text-gray-900 dark:text-white">
            {totalData}
